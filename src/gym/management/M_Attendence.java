 ...
 * @author anand
 */
public class M_Attendence extends javax.swing.JFrame {

    /** Creates new form M_Attendence */
    public M_Attendence() {
        initComponents();
    }
    ...
    private void txttimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txttimeMouseClicked
        ...
        try{
            ...
            String  q="select time from member where id=?";
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/gym","root","Admin");
            String q="insert into M_Attendance values(?,?,?,?)";
            PreparedStatement ps=con.prepareStatement(q);
            ps.setInt(1,id);
                    try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M_Attendence.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
